...
const ServiceCard = () => {
  return (
    <div className="relative w-72 bg-coal-800 rounded-xl shadow-dark border border-coal-600 hover:shadow-accent-20 hover:border-accent-yellow hover:cursor-pointer hover:-translate-y-1 p-6 flex flex-col gap-3 items-center transition-all duration-200 ease-in group mt-6">
      <Image
        src={ServiceImage1}
        alt="Ходова частина"
